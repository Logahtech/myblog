...
<div class="site-section">
    ...
    <form action= "add_staff_action.php" method="POST" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-6 form-group">
                <label for="aid">Admin ID</label>
                <input type="text" id="aid" name="aid" value="<?php echo $_SESSION['admin_id']; ?>" class="form-control form-control-lg">
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 form-group">
