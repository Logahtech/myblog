                ...
                echo "<div class='col-lg-6'>";
                    echo "<div class='post-entry-big horizontal d-flex mb-4'>";
                        ...
                        echo "<div class='post-meta'>";
                            echo "<a href='delete_blog_action.php?id={$found_blog['id']}' class='btn btn-primary rounded-0 px-4'>Remove</a>";
                        echo "</div>";
                            echo "<h3 class='post-heading'>{$found_blog['article_name']}</h3>";
                        echo "</div>";
                    echo "</div>";
                echo "</div>";
            echo "</div>";
