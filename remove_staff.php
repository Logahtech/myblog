...
echo "<div class='site-section'>";
    echo "<div class='container'>";
        ...
        while ($found_staff = mysqli_fetch_array($result_set)) {
            echo "<div class='ftco-testimonial-1'>";
                echo "<div class='ftco-testimonial-vcard d-flex align-items-center mb-4'>";
                    echo "<img src='images/" .$found_staff['image']."'" . "alt='Image' class='img-fluid mr-3'>";
                    echo "<div>";
                        echo "<h3>". $found_staff['id'] . "</h3>";
                        echo "<span>" . $found_staff['username'] . "</span>";
                        echo "<a href='remove_staff_action.php?id={$found_staff['id']}'> Remove</a>";
                    echo "</div>";
                echo "</div>";
            echo "</div>";
        }
